...
namespace GameMaker.Currency.Runtime
{
    public class CurrencyActionDefinition : BaseActionDefinition
    {
        ...
        public CurrencyActionDefinition(string id, string name, string title) : base(id, name, title)
        {
        }

        public override object Clone()
        {
            return new CurrencyActionDefinition(id, name, title);
        }
        ...
        public override List<BaseActionDefinition> GetCoreActionDefinition()
        {
            ...
            {
                new CurrencyActionDefinition(ADD_CURRENCY_ACTION_DEFINITION_ID, "ADD_CURRENCY_ACTION", "ADD_CURRENCY_ACTION")
            };
        }
