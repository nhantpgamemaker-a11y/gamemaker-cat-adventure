...
namespace GameMaker.Currency.Runtime
{
    public class CurrencyActionDefinition : BaseActionDefinition
    {
        ...
        public CurrencyActionDefinition(string id, string name, string title,string description, Sprite icon):base(id, name, title,description, icon)
        {
        }

        public override object Clone()
        {
            return new CurrencyActionDefinition(GetID(), GetName(), GetTitle(), GetDescription(), GetIcon());
        }
        ...
        public override List<BaseActionDefinition> GetCoreActionDefinition()
        {
            ...
            {
                new CurrencyActionDefinition(ADD_CURRENCY_ACTION_DEFINITION_ID, "ADD_CURRENCY_ACTION", "ADD_CURRENCY_ACTION","", null)
            };
        }
