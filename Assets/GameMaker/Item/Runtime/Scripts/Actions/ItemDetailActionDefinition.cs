...
namespace GameMaker.Item.Runtime
{
    ...
    public class ItemDetailActionDefinition : BaseActionDefinition
    {
        ...
        public ItemDetailActionDefinition(string id, string name, string title) : base(id, name, title)
        {
        }

        public override object Clone()
        {
            return new ItemDetailActionDefinition(id, name, title);
        }
        ...
        public override List<BaseActionDefinition> GetCoreActionDefinition()
        {
            ...
            {
                new ItemActionDefinition(ADD_ITEM_DETAIL_ACTION_DEFINITION_ID, "ADD_ITEM_DETAIL_ACTION", "ADD_ITEM_DETAIL_ACTION"),
                new ItemActionDefinition(REMOVE_ITEM_DETAIL_ACTION_DEFINITION_ID, "REMOVE_ITEM_DETAIL_ACTION", "REMOVE_ITEM_DETAIL_ACTION")
            };
        }
