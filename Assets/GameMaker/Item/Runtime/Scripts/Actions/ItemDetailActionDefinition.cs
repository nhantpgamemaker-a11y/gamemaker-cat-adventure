...
namespace GameMaker.Item.Runtime
{
    ...
    public class ItemDetailActionDefinition : BaseActionDefinition
    {
        ...
        public ItemDetailActionDefinition(string id, string name, string title,string description, Sprite icon) : base(id, name, title,description, icon)
        {
        }

        public override object Clone()
        {
            return new ItemDetailActionDefinition(GetID(), GetName(), GetTitle(), GetDescription(), GetIcon());
        }
        ...
        public override List<BaseActionDefinition> GetCoreActionDefinition()
        {
            ...
            {
                new ItemActionDefinition(ADD_ITEM_DETAIL_ACTION_DEFINITION_ID, "ADD_ITEM_DETAIL_ACTION", "ADD_ITEM_DETAIL_ACTION","",null),
                new ItemActionDefinition(REMOVE_ITEM_DETAIL_ACTION_DEFINITION_ID, "REMOVE_ITEM_DETAIL_ACTION", "REMOVE_ITEM_DETAIL_ACTION","", null)
            };
        }
