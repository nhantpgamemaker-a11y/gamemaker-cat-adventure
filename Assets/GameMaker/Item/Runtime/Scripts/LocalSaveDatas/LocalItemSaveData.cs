...
namespace GameMaker.Item.Runtime
{
    ...
    public class LocalItemSaveData : BaseLocalData
    {
        ...
        public void UpdateItemDetail(string playerItemDetailReferenceId,

        params ItemStatDefinitionRefModel[] itemStatDefinitionRefModels)
        {
        ...
        public void AddPlayerItemDetail(PlayerDetailItem playerDetailItem)
        {
