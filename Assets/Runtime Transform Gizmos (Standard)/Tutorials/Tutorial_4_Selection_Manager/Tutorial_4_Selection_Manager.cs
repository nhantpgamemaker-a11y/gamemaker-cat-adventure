...
namespace RTGStandard
{
    ...
    //-----------------------------------------------------------------------------
    // Name: Tutorial_4_Selection_Manager (Public Class)
    // Desc: Tutorial class which implements a simple selection manager similar to
    //       what you would find a typical editor application. The demo will allow
    //       us to:
    //          1. Pick objects from the scene using the mouse.
    //          2. Keep track of currently selected objects.
    //          3. Switch between different gizmo types using hotkeys.
    //          4. Toggle gizmo transform space using hotkeys.
    //          5. Toggle between relative and absolute move snapping.
    //          6. Focus the camera on the currently selected objects.
    //-----------------------------------------------------------------------------
    public class Tutorial_4_Selection_Manager : MonoBehaviour
    {
        ...
        //-----------------------------------------------------------------------------
        // Name: OnGUI() (Private Function)
        // Desc: Called by Unity to allow us to do any UI related stuff.
        //-----------------------------------------------------------------------------
        void OnGUI()
        {
