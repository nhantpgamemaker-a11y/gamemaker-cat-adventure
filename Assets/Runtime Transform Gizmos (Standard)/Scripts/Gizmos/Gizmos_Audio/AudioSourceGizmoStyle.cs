...
namespace RTGStandard
{
    ...
    //-----------------------------------------------------------------------------
    // Name: AudioSourceGizmoStyle (Public Class)
    // Desc: Stores style properties for audio source gizmos.
    //-----------------------------------------------------------------------------
    [Serializable] public class AudioSourceGizmoStyle : GizmoStyle
    {
        ...
        //-----------------------------------------------------------------------------
        public AudioSourceGizmoStyle CloneStyle()
        {
            // Clone
            var clone               = MemberwiseClone() as AudioSourceGizmoStyle;
