...
namespace RTGStandard
{
    ...
    //-----------------------------------------------------------------------------
    // Name: RotateGizmo (Public Class)
    // Desc: Implements a gizmo which can be used to rotate entities.
    //-----------------------------------------------------------------------------
    public class RotateGizmo : Gizmo
    {
        #region Private Fields
        RotateGizmoProxy mProxy;  // Rotate gizmo proxy which provides the actual implementation
        #endregion

        #region Public Properties
        //-----------------------------------------------------------------------------
        // Name: style (Public Property)
        // Desc: Returns or sets the rotate gizmo style.
        //-----------------------------------------------------------------------------
        public RotateGizmoStyle style           { get; set; } = null;

        //-----------------------------------------------------------------------------
        // Name: activeStyle (Public Property)
        // Desc: Returns the active style used by the gizmo. This is 'style' if it was set
        //       to a valid style. Otherwise, it is the active skin's rotate gizmo style.
        //-----------------------------------------------------------------------------
        public RotateGizmoStyle activeStyle     { get { return style == null ? RTGizmos.get.skin.rotateGizmoStyle : style; } }
        #endregion
        ...
        protected override void OnCreateHandles(List<GizmoHandle> handles)
        {
            ...
            mProxy = new RotateGizmoProxy(this, 0);
