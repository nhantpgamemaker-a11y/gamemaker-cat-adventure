...
namespace RTGStandard
{
    ...
    //-----------------------------------------------------------------------------
    // Name: CapsuleCollider2DGizmoStyle (Public Class)
    // Desc: Stores style properties for 2D capsule collider gizmos.
    //-----------------------------------------------------------------------------
    [Serializable] public class CapsuleCollider2DGizmoStyle : GizmoStyle
    {
        ...
        //-----------------------------------------------------------------------------
        public CapsuleCollider2DGizmoStyle CloneStyle()
        {
            var clone               = MemberwiseClone() as CapsuleCollider2DGizmoStyle;
