...
namespace RTGStandard
{
    ...
    //-----------------------------------------------------------------------------
    // Name: CircleCollider2DGizmoStyle (Public Class)
    // Desc: Stores style properties for 2D circle collider gizmos.
    //-----------------------------------------------------------------------------
    [Serializable] public class CircleCollider2DGizmoStyle : GizmoStyle
    {
        ...
        [SerializeField] GizmoCapStyle  mRadiusCapStyle         = new GizmoCapStyle();  // Radius cap style. Radius caps are the handles that are used to change the circle radius.
        #endregion
        ...
        //-----------------------------------------------------------------------------
        public CircleCollider2DGizmoStyle CloneStyle()
        {
            var clone                   = MemberwiseClone() as CircleCollider2DGizmoStyle;
