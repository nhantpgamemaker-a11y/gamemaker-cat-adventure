...
namespace RTGStandard
{
    ...
    //-----------------------------------------------------------------------------
    // Name: BoxColliderGizmoStyle (Public Class)
    // Desc: Stores style properties for box collider gizmos.
    //-----------------------------------------------------------------------------
    [Serializable] public class BoxColliderGizmoStyle : GizmoStyle
    {
        ...
        //-----------------------------------------------------------------------------
        public BoxColliderGizmoStyle CloneStyle()
        {
            // Clone
            var clone               = MemberwiseClone() as BoxColliderGizmoStyle;
