...
namespace RTGStandard
{
    ...
    //-----------------------------------------------------------------------------
    // Name: CharacterControllerGizmoStyle (Public Class)
    // Desc: Stores style properties for character controller gizmos.
    //-----------------------------------------------------------------------------
    [Serializable] public class CharacterControllerGizmoStyle : GizmoStyle
    {
        ...
        //-----------------------------------------------------------------------------
        public CharacterControllerGizmoStyle CloneStyle()
        {
            var clone               = MemberwiseClone() as CharacterControllerGizmoStyle;
