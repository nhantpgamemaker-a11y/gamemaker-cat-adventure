    ...
    public partial class UVEditorWindow : EditorWindow
    {
        ...
        private void startNewTextureEditCycle(bool recordUndo)
        {
            ...
            if (recordUndo)
            {
                ...
                UndoStack.Instance.AddUndoAction(undoAssignMeshOnGameObjectFunc(SelectedGameObject, GetSharedMeshFromGameObject(SelectedGameObject, _selectedMesh)));
            ...
            _textureMaterial.SetMainTexture(_texture);
            ...
            {
                UndoStack.Instance.StartEntry();
                var currentMesh = GetSharedMeshFromGameObject(SelectedGameObject, _selectedMesh);
