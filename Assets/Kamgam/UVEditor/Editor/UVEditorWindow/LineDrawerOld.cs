...
{
    public class LineDrawerOld : VisualElement
    {
        ...
        private void OnGenerateVisualContent(MeshGenerationContext mgc)
        {
			...
			// Here is an example of painter drawin into a render texture:
			// https://discussions.unity.com/t/introducing-the-vector-api-in-unity-2022-1/864911/114
        ...
        public new class UxmlFactory : UxmlFactory<LineDrawerOld, UxmlTraits> { }
#endif
    }
}
