...
namespace Kamgam.UVEditor
{
    partial class UVTriangleSelectTool
    {
        ...
        public void onSelectRenderMesh()
        {
            ...
            {
                var color = UVEditorSettings.GetOrCreateSettings().HoverColor;
                if (_removeFromSelection)
                {
                    color = UVEditorSettings.GetOrCreateSettings().DeselectColor;
                }
            ...
            {
                var color = UVEditorSettings.GetOrCreateSettings().SelectionColor;
                color.a = UVEditorSettings.GetOrCreateSettings().SelectionColorAlpha;
                if (UVEditorWindow.Instance != null && UVEditorWindow.Instance.IsMouseInside)
                    color.a = UVEditorSettings.GetOrCreateSettings().SelectionColorAlphaUV;
