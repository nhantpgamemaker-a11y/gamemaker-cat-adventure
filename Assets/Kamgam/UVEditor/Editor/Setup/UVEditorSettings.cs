...
namespace Kamgam.UVEditor
{
    ...
    public class UVEditorSettings : ScriptableObject
    {
        ...
        public Color SelectionColor = new Color(0f, 1f, 0f);
        public Color HoverColor = new Color(1f, 1f, 0f);
        public Color DeselectColor = new Color(1f, 0f, 0f);

        [Range(0,1)]
        public float SelectionColorAlpha;
        
        [Range(0, 1)]
        [Tooltip("The alpha of the selected triangles in the scene view if the mouse is inside the UV editor (useful to reduce while dragging UVs in live mode).")]
        public float SelectionColorAlphaUV = 0.05f;
        ...
        public static UVEditorSettings GetOrCreateSettings()
        {
            if (cachedSettings == null)
            {
                ...
                if (cachedSettings == null)
                {
                    ...
                    cachedSettings.SelectionColor = new Color(0f, 1f, 0f);
                    cachedSettings.HoverColor = new Color(1f, 1f, 0f);
                    cachedSettings.DeselectColor = new Color(1f, 0f, 0f);
                    cachedSettings.SelectionColorAlpha = 0.5f;
                    cachedSettings.SelectionColorAlphaUV = 0.05f;
